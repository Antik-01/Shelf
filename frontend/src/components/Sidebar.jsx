  ...
  return (
    ...
    >
      ...
      <div className="flex h-16 items-center gap-2.5 border-b border-slate-700/50 px-6">
        ...
        <span className="text-lg font-bold text-white">Shelf</span>
      ...
      {/* Footer */}
      <div className="absolute bottom-0 left-0 right-0 border-t border-slate-700/50 px-6 py-4">
        <p className="text-xs text-slate-500">Shelf v1.0.0</p>
        <p className="text-xs text-slate-600">Storage Management</p>
      </div>
    </aside>
  )
}
